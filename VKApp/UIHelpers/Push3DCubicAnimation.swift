...
import Foundation
import UIKit
final class Push3DCubicAnimation: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        var viewToTransform: CATransform3D = CATransform3DMakeRotation(-.pi / 2, 0.0, 1.0, 0.0)
